...
const authUser = async (req, res, next) => {
  ...
  try {
    ...
    req.body.userId = token_decode.id // by doing this we will get the user id from the token and it will be added in the req.body and we can use this user id in our controller function.
