            ...
            <div className="flex flex-col gap-2 justify-end">
              ...
              {!item.cancelled && !item.payment && !item.isCompleted && (
                <button
                  ...
                  className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-blue-800 hover:text-white transition-all duration-300"
                >
                  Pay Online
                </button>
              )}
              ...
              {item.isCompleted && (
                <button className="sm:min-w-48 py-2 border border-green-700 rounded text-green-500">
                  Completed
                </button>
              )}
            </div>
