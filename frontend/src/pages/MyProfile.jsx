...
const MyProfile = () => {
  const [userData, setUserData] = useState({
    ...
    phone: "8989898989",
    address: {
      line1: "CSR, Ground floor",
      line2: "CST Mumbai",
    },
    gender: "Male",
    dob: "2000-01-22",
  });
  // using this data we will display on UI side.
